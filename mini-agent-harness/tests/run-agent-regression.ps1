...
Invoke-AgentCheck 'Integrated Python agent tests' "$harnessRoot\python" {
  python -m unittest -v test_agent_runtime.py test_compact.py test_instructions.py test_memory.py test_tool_scheduler.py test_extension_decision.py test_extension_registry.py test_mcp_session.py test_work_coordinator.py test_transcript_recovery.py test_security_boundary.py test_observability_governance.py test_release_control_plane.py test_streaming.py
}
